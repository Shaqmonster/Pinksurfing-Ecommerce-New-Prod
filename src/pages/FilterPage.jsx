...
export default function Filter() {
  ...
  const AddtoWishlist = (productId) => {
    axios
      .post(
        `${import.meta.env.VITE_SERVER_URL}/api/customer/wishlist/add/${productId}`,
        {},
        {
          headers: {
            ...
            <div className="fixed inset-0 z-40 flex">
              ...
              >
                <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white dark:bg-black py-4 pb-12 shadow-xl">
                  ...
                  {/* Filters */}
                  <form className="mt-4 border-t dark:bg-black border-gray-200">
              ...
              <div className="lg:col-span-3">
                <div className="bg-white dark:bg-black">
                  <div className=" w-full  sm:py-0 sm:pb-10  lg:px-0">
                    <div className=" grid grid-cols-2 pb-6 sm:grid-cols-2 lg:grid-cols-3 gap-x-0.5 gap-y-1 lg:gap-x-2 lg:items-center lg:justify-start flex-wrap">
