          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-white/40 text-sm max-w-xl mx-auto">
                Explore hundreds of service categories and find exactly what you need.
              </p>
            </div>
              ...
              {categories.slice(0, 12).map((cat, i) => {
                ...
                return (
                  <motion.button
                    ...
                    onClick={() => navigate(`/gigs?category_slug=${cat.slug}`)}
                    className={`flex flex-col items-center gap-3 p-4 bg-gradient-to-b ${gradient} border border-white/5 rounded-2xl hover:border-white/15 transition-all text-center group`}
                  >
                    <div className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center group-hover:bg-white/10 transition-all">
                      <Icon className="text-xl text-white/60 group-hover:text-white/90 transition-colors" />
                    </div>
